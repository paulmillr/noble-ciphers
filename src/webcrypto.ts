 ...
 * @module
 */
import { abytes, anumber, type AsyncCipher, type Uint8ArrayBuffer } from './utils.ts';
 ...
 */
export const utils: {
  encrypt: (key: Uint8Array, ...all: any[]) => Promise<Uint8ArrayBuffer>;
  decrypt: (key: Uint8Array, ...all: any[]) => Promise<Uint8ArrayBuffer>;
} = {
  async encrypt(
    key: Uint8Array,
    keyParams: any,
