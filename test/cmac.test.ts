...
describe('AES-CMAC', () => {
  ...
  const rfcTestVectors = [
    ...
    },
    {
      ...
      message: hexToBytes('6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411'),
      expected: 'dfa66747de9ae63030ca32611497c827'
    },
    {
      name: 'Test Case 4: 64-byte message',
      message: hexToBytes('6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411e5fbc1191a0a52eff69f2445df4f9b17ad2b417be66c3710'),
  ...
  describe('Streaming interface', () => {
    ...
    should('work with multiple updates', () => {
      const mac = cmac.create(RFC4493_KEY);
      const message = hexToBytes('6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411');
